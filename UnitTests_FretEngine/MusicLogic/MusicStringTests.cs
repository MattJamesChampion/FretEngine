...
namespace UnitTests_FretEngine.MusicLogic
{
    ...
    class MusicStringTests
    {
        ...
        [TestCase(AbstractMusicNote.ENaturalFFlat, 4, null, 21, AbstractMusicNote.GNatural, 2, null)]
        [TestCase(AbstractMusicNote.BNaturalCFlat, 7, 18, 0, AbstractMusicNote.BNaturalCFlat, 7, 18)]
        [TestCase(AbstractMusicNote.FSharpGFlat, 0, 66, 7, AbstractMusicNote.BNaturalCFlat, -1, 66)]
        [TestCase(AbstractMusicNote.GSharpAFlat, -12, 12, -20, AbstractMusicNote.ENaturalFFlat, -10, 12)]
        [TestCase(AbstractMusicNote.DSharpEFlat, 16, 48, 72, AbstractMusicNote.DSharpEFlat, 10, 48)]
        [TestCase(AbstractMusicNote.ESharpFNatural, null, 7, 29, AbstractMusicNote.BSharpCNatural, null, 7)]
        [TestCase(AbstractMusicNote.BSharpCNatural, null, 32, 0, AbstractMusicNote.BSharpCNatural, null, 32)]
        [TestCase(AbstractMusicNote.ANatural, null, 0, -13, AbstractMusicNote.ASharpBFlat, null, 0)]
        public void Flatten_WhenGivenValidDecrementQuantity_ShouldUpdateCorrectly(AbstractMusicNote startNote, int? startOctave, int? startLastPosition, int decrementQuantity, AbstractMusicNote expectedAbstractMusicNote, int? expectedOctave, int? expectedLastPosition)
        {
            var expectedMusicNote = new MusicNote(expectedAbstractMusicNote, expectedOctave);
            var expectedMusicString = new MusicString(expectedMusicNote, expectedLastPosition);
        ...
        [TestCase(AbstractMusicNote.BNaturalCFlat, 0, 6, 0)]
        [TestCase(AbstractMusicNote.ESharpFNatural, -13, 28, 1)]
        [TestCase(AbstractMusicNote.ANatural, 22, 10, 7)]
        [TestCase(AbstractMusicNote.BSharpCNatural, 6, 102, 54)]
        [TestCase(AbstractMusicNote.GNatural, null, 200, 200)]
        [TestCase(AbstractMusicNote.DNatural, -22, null, 300)]
        [TestCase(AbstractMusicNote.ASharpBFlat, null, null, 500)]
        public void IsValidMusicStringPosition_WhenGivenValidMusicStringPosition_ShouldReturnTrue(AbstractMusicNote testAbstractMusicNote, int? testOctave, int? testLastPosition, int musicStringPosition)
        {
            var testMusicNote = new MusicNote(testAbstractMusicNote, testOctave);
            var testMusicString = new MusicString(testMusicNote, testLastPosition);

            Assert.IsTrue(testMusicString.IsValidMusicStringPosition(musicStringPosition));
        }

        [TestCase(AbstractMusicNote.ESharpFNatural, -8, 50, -1)]
        [TestCase(AbstractMusicNote.CSharpDFlat, 16, 0, 3)]
        [TestCase(AbstractMusicNote.FSharpGFlat, 35, 5, 8)]
        [TestCase(AbstractMusicNote.ANatural, 0, 25, 50)]
        [TestCase(AbstractMusicNote.GSharpAFlat, null, 100, 132)]
        [TestCase(AbstractMusicNote.GNatural, 5, null, -22)]
        [TestCase(AbstractMusicNote.DNatural, null, null, -78)]
        public void IsValidMusicStringPosition_WhenGivenInvalidMusicStringPosition_ShouldReturnFalse(AbstractMusicNote testAbstractMusicNote, int? testOctave, int? testLastPosition, int musicStringPosition)
        {
            var testMusicNote = new MusicNote(testAbstractMusicNote, testOctave);
            var testMusicString = new MusicString(testMusicNote, testLastPosition);

            Assert.IsFalse(testMusicString.IsValidMusicStringPosition(musicStringPosition));
        }

        [TestCase(AbstractMusicNote.ESharpFNatural, 4, 50, 40, AbstractMusicNote.ANatural, 7)]
        [TestCase(AbstractMusicNote.BSharpCNatural, 17, 12, 12, AbstractMusicNote.BSharpCNatural, 18)]
        [TestCase(AbstractMusicNote.BNaturalCFlat, 0, 3, 1, AbstractMusicNote.BSharpCNatural, 1)]
        [TestCase(AbstractMusicNote.GNatural, -12, 0, 0, AbstractMusicNote.GNatural, -12)]
        [TestCase(AbstractMusicNote.ENaturalFFlat, 9, null, 92, AbstractMusicNote.BSharpCNatural, 17)]
        [TestCase(AbstractMusicNote.GSharpAFlat, null, 40, 38, AbstractMusicNote.ASharpBFlat, null)]
        [TestCase(AbstractMusicNote.ASharpBFlat, null, 8, 0, AbstractMusicNote.ASharpBFlat, null)]
        [TestCase(AbstractMusicNote.CSharpDFlat, null, null, 86, AbstractMusicNote.DSharpEFlat, null)]
        public void GetMusicNoteAtMusicStringPosition_WhenGivenValidMusicStringPosition_ShouldReturnCorrectValues(AbstractMusicNote startAbstractMusicNote, int? startOctave, int? startLastPosition, int musicStringPosition, AbstractMusicNote expectedAbstractMusicNote, int? expectedOctave)
        {
            var expectedMusicNote = new MusicNote(expectedAbstractMusicNote, expectedOctave);

            var testMusicNote = new MusicNote(startAbstractMusicNote, startOctave);
            var testMusicString = new MusicString(testMusicNote, startLastPosition);
        ...
        [TestCase(AbstractMusicNote.BSharpCNatural, 0, 24, -1)]
        [TestCase(AbstractMusicNote.ENaturalFFlat, 4, null, -6)]
        [TestCase(AbstractMusicNote.GNatural, 14, 5, 271)]
        [TestCase(AbstractMusicNote.ANatural, -12, 3, 9)]
        [TestCase(AbstractMusicNote.GSharpAFlat, 8, 25, 30)]
        [TestCase(AbstractMusicNote.BNaturalCFlat, null, 48, 50)]
        [TestCase(AbstractMusicNote.CSharpDFlat, -13, null, -12)]
        [TestCase(AbstractMusicNote.FSharpGFlat, null, null, -50)]
        public void GetMusicNoteAtMusicStringPosition_WhenGivenInvalidMusicStringPosition_ShouldThrowInvalidMusicStringPositionException(AbstractMusicNote testAbstractMusicNote, int? testOctave, int? testLastPosition, int musicStringPosition)
        {
            var testMusicNote = new MusicNote(testAbstractMusicNote, testOctave);
            var testMusicString = new MusicString(testMusicNote, testLastPosition);
        ...
        [TestCase(AbstractMusicNote.BNaturalCFlat, 8, 15, 0, 12)]
        [TestCase(AbstractMusicNote.ANatural, 0, 7, 7, 7)]
        [TestCase(AbstractMusicNote.CSharpDFlat, -6, 40, 34, 37)]
        [TestCase(AbstractMusicNote.GSharpAFlat, 17, 200, 100, 200)]
        [TestCase(AbstractMusicNote.DNatural, 4, 30, 2, 10)]
        [TestCase(AbstractMusicNote.GNatural, null, 50, 11, 48)]
        [TestCase(AbstractMusicNote.BSharpCNatural, -12, null, 0, 500)]
        [TestCase(AbstractMusicNote.DSharpEFlat, null, null, 2, 30)]
        public void GetMusicNotes_WhenGivenValidValues_ShouldReturnCorrectValues(AbstractMusicNote testAbstractMusicNote, int? testOctave, int? testLastPosition, int startPosition, int endPosition)
        {
            var testMusicNote = new MusicNote(testAbstractMusicNote, testOctave);
        ...
        [TestCase(AbstractMusicNote.GNatural, -8, 100, 100, 10)]
        [TestCase(AbstractMusicNote.BNaturalCFlat, 26, 15, 9, 8)]
        [TestCase(AbstractMusicNote.CSharpDFlat, 0, 5, 3, 2)]
        [TestCase(AbstractMusicNote.DSharpEFlat, -2, 30, 20, 10)]
        [TestCase(AbstractMusicNote.ANatural, 13, null, 7, 2)]
        [TestCase(AbstractMusicNote.DNatural, null, 18, 18, 17)]
        public void GetMusicNotes_WhenEndPositionIsGreaterThanStartPosition_ShouldThrowArgumentException(AbstractMusicNote testAbstractMusicNote, int? testOctave, int? testLastPosition, int startPosition, int endPosition)
        {
            var testMusicNote = new MusicNote(testAbstractMusicNote, testOctave);
        ...
        [TestCase(AbstractMusicNote.GNatural, 8, 20, -3, 20)]
        [TestCase(AbstractMusicNote.BSharpCNatural, 21, 22, -1, 7)]
        [TestCase(AbstractMusicNote.CSharpDFlat, -7, 186, -20, 2)]
        [TestCase(AbstractMusicNote.ASharpBFlat, 14, 24, 93, 12)]
        [TestCase(AbstractMusicNote.ENaturalFFlat, 0, null, -14, 0)]
        [TestCase(AbstractMusicNote.BNaturalCFlat, null, 18, 80, 16)]
        public void GetMusicNotes_WhenGivenInvalidStartPosition_ShouldThrowInvalidMusicStringPositionException(AbstractMusicNote testAbstractMusicNote, int? testOctave, int? testLastPosition, int startPosition, int endPosition)
        {
            var testMusicNote = new MusicNote(testAbstractMusicNote, testOctave);
        ...
        [TestCase(AbstractMusicNote.DSharpEFlat, 17, 6, 12, -1)]
        [TestCase(AbstractMusicNote.BNaturalCFlat, 4, 2, 6, 8)]
        [TestCase(AbstractMusicNote.BSharpCNatural, -3, 62, 2, 200)]
        [TestCase(AbstractMusicNote.ENaturalFFlat, 0, 587, 0, -49)]
        [TestCase(AbstractMusicNote.GNatural, -11, 0, 50, -17)]
        [TestCase(AbstractMusicNote.FSharpGFlat, null, null, 17, -90)]
        public void GetMusicNotes_WhenGivenInvalidEndPosition_ShouldThrowInvalidMusicStringPositionException(AbstractMusicNote testAbstractMusicNote, int? testOctave, int? testLastPosition, int startPosition, int endPosition)
        {
            var testMusicNote = new MusicNote(testAbstractMusicNote, testOctave);
        ...
        [TestCase(AbstractMusicNote.ESharpFNatural, -8, 14, 0)]
        [TestCase(AbstractMusicNote.GNatural, 7, 29, 5)]
        [TestCase(AbstractMusicNote.BNaturalCFlat, 5, 100, 13)]
        [TestCase(AbstractMusicNote.ANatural, 0, 30, 30)]
        [TestCase(AbstractMusicNote.DNatural, 19, null, 19)]
        [TestCase(AbstractMusicNote.GSharpAFlat, null, 58, 47)]
        public void GetMusicNotes_WhenGivenValidEndPosition_ShouldReturnCorrectValues(AbstractMusicNote testAbstractMusicNote, int? testOctave, int? testLastPosition, int endPosition)
        {
            var testMusicNote = new MusicNote(testAbstractMusicNote, testOctave);
        ...
        [TestCase(AbstractMusicNote.ENaturalFFlat, 0, 91, -1)]
        [TestCase(AbstractMusicNote.ASharpBFlat, 15, 268, -29)]
        [TestCase(AbstractMusicNote.BSharpCNatural, 2, 5, 7)]
        [TestCase(AbstractMusicNote.GNatural, 7, 30, 96)]
        [TestCase(AbstractMusicNote.ANatural, -12, 0, 4)]
        [TestCase(AbstractMusicNote.FSharpGFlat, null, null, -35)]
        public void GetMusicNotes_WhenGivenInvalidEndPosition_ShouldThrowInvalidMusicStringPositionException(AbstractMusicNote testAbstractMusicNote, int? testOctave, int? testLastPosition, int endPosition)
        {
            var testMusicNote = new MusicNote(testAbstractMusicNote, testOctave);
        ...
        [TestCase(AbstractMusicNote.ESharpFNatural, -19, 157, AbstractMusicNote.FSharpGFlat, -6)]
        [TestCase(AbstractMusicNote.DNatural, null, null, AbstractMusicNote.ESharpFNatural, null)]
        [TestCase(AbstractMusicNote.DSharpEFlat, 4, 12, AbstractMusicNote.ESharpFNatural, 4)]
        [TestCase(AbstractMusicNote.BNaturalCFlat, null, 300, AbstractMusicNote.ANatural, null)]
        [TestCase(AbstractMusicNote.ASharpBFlat, 0, 48, AbstractMusicNote.ASharpBFlat, 0)]
        [TestCase(AbstractMusicNote.GNatural, null, 0, AbstractMusicNote.GNatural, null)]
        public void HasMusicNote_WhenGivenValidMusicNote_ShouldReturnTrue(AbstractMusicNote testAbstractMusicNote, int? testOctave, int? testLastPosition, AbstractMusicNote targetAbstractMusicNote, int? targetOctave)
        {
            var testMusicNote = new MusicNote(testAbstractMusicNote, testOctave);
            var testMusicString = new MusicString(testMusicNote, testLastPosition);
        ...
        [TestCase(AbstractMusicNote.ENaturalFFlat, 19, 11, AbstractMusicNote.ENaturalFFlat, 20)]
        [TestCase(AbstractMusicNote.ASharpBFlat, 7, 2, AbstractMusicNote.GNatural, 20)]
        [TestCase(AbstractMusicNote.CSharpDFlat, -12, 500, AbstractMusicNote.CSharpDFlat, -13)]
        [TestCase(AbstractMusicNote.ESharpFNatural, 0, null, AbstractMusicNote.CSharpDFlat, -6)]
        [TestCase(AbstractMusicNote.BNaturalCFlat, -2, null, AbstractMusicNote.DSharpEFlat, -2)]
        [TestCase(AbstractMusicNote.BSharpCNatural, null, 0, AbstractMusicNote.CSharpDFlat, null)]
        [TestCase(AbstractMusicNote.GNatural, null, 4, AbstractMusicNote.BSharpCNatural, null)]
        public void HasMusicNote_WhenGivenNonexistentMusicNote_ShouldReturnFalse(AbstractMusicNote testAbstractMusicNote, int? testOctave, int? testLastPosition, AbstractMusicNote targetAbstractMusicNote, int? targetOctave)
        {
            var testMusicNote = new MusicNote(testAbstractMusicNote, testOctave);
            var testMusicString = new MusicString(testMusicNote, testLastPosition);
        ...
        [TestCase(AbstractMusicNote.ENaturalFFlat, null, null, AbstractMusicNote.DNatural, 0)]
        [TestCase(AbstractMusicNote.DSharpEFlat, 3, 41, AbstractMusicNote.DNatural, null)]
        [TestCase(AbstractMusicNote.ASharpBFlat, null, 69, AbstractMusicNote.FSharpGFlat, -7)]
        [TestCase(AbstractMusicNote.GSharpAFlat, 30, 32, AbstractMusicNote.ANatural, null)]
        [TestCase(AbstractMusicNote.GNatural, null, null, AbstractMusicNote.GNatural, 19)]
        public void HasMusicNote_WhenGivenIncomparableMusicStringAndMusicNote_ShouldReturnFalse(AbstractMusicNote testAbstractMusicNote, int? testOctave, int? testLastPosition, AbstractMusicNote targetAbstractMusicNote, int? targetOctave)
        {
            var testMusicNote = new MusicNote(testAbstractMusicNote, testOctave);
            var testMusicString = new MusicString(testMusicNote, testLastPosition);
